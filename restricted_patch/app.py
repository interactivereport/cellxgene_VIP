# target: server/app/app.py
# changes made --
#       install_VIP.sh had already appended a VIPInterface route to the end of the cellxgene original.
#       here the patch modify def dataset_index()
...
def dataset_index():
    ...
    restricted = dataset_config.app__restricted

    try:
        args = {"SCRIPTS": scripts, "INLINE_SCRIPTS": inline_scripts, "restricted":restricted}
