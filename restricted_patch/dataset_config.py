# target server/common/config/dataset_config.py
# changes made --
#       add a self.app_restricted and a self.app_identifier at def __init__
#       add a self.validate for restricted and identifier at def handle_app
...
class DatasetConfig(BaseConfig):
    ...
    def __init__(self, tag, app_config, default_config):
        ...
        try:
            ...
            self.app__restricted = default_config["app"].get("restricted", False)
            self.app__identifier = default_config["app"].get("identifier", "null")
    ...
    def handle_app(self):
        ...
        self.validate_correct_type_of_configuration_attribute("app__restricted", bool)
        self.validate_correct_type_of_configuration_attribute("app__identifier", str)
