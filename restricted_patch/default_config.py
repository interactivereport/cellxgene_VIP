# target: server/default_config.py
# changes made:
#   add two new defaults under dataset.app -- restricted: false & identifier: null
...
dataset:
  app:
    ...
    inline_scripts: []
    # Restricted if true, then getdata button and CLI window will both be disabled
    restricted: false
    # identifier is a string used to name the .timestamp file, so to distinguish instances from the same source
    identifier: "null" # NOTE: "null" MUST BE QUOTED
