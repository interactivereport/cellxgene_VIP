# target server/common/config/server_config.py
# changes made:
#       add a self.dataset__app__restricted and a self.dataset__app__identifier to def __init__
#       add a def handle_dataset_app(self)... 
#       add a self.handle_dataset_app() to def complete_config
...
class ServerConfig(BaseConfig):
    ...
    def __init__(self, app_config, default_config):
        ...
        try:
            ...
            self.dataset__app__restricted = default_config["app"].get("restricted", False)
            self.dataset__app__identifier = default_config["app"].get("identifier", "null")
    ...
    def handle_dataset_app(self):
        self.validate_correct_type_of_configuration_attribute("dataset__app__restricted", bool)
        self.validate_correct_type_of_configuration_attribute("dataset__app__identifier", str)
