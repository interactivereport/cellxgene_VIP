...
#print(head(row.names(sce)))

#sce = saveRDS(sce,"/home/ed/CXG_Testing/nTb_GAM_line.rds")
...
#print("in function counts check")
  #print(rownames(counts)[-1,])

  #print("in function sce check")
  #print(names(models)[-1,])

  #print(head(counts[names(models),]))

#rownames(rowData(sce)$tradeSeq) = rownames(sce)

#saveRDS(sce,"/home/ed/CXG_Testing/nTb_GAM_line.rds")